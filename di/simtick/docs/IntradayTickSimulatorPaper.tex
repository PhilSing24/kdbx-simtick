...
Each module carries a suite of checks run by a k4unit harness, 110 for simtick, 109 for simcalendar and 173 for simorder, that hold the invariants (every trade inside its prevailing quote, spreads whole ticks, quantities conserved, events consistent with fills) and the statistics below.
