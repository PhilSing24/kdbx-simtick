...
- **Tape-consistent fills** — fill prices sit on a tenth of a tick, as trades print on the tape; aggressive fills are at the far touch in force or one tick beyond, passive fills at the child's limit; each fill carries its venue, whether it added or removed liquidity, and the order's capacity
